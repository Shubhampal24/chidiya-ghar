  ...
  return (
    <>
      <div className={"et_pb_section et_pb_section_3 et_pb_with_background et_section_regular"}>
        ...
        <div className={"et_pb_row et_pb_row_6 dh-custom-5-cards-row"}>
          {"\n\t\t\t\t"}
          <div className={"dh-acc-card-col dh-col-1"}>
            {"\n\t\t\t\t\t"}
            <div
              className={
                "et_pb_with_border et_pb_module mphb-divi-single-accommodation mphb-divi-single-accommodation_0 dh-custom-single-acc dh-custom-amenities dh-custom-price-acc"
              }
            >
              {"\n\t\t\t\t\t\t"}
