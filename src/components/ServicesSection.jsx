        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 20px" }}> 
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(250px, 1fr))", gap: "20px" }}> 
            ...
            <div className="dh-service-card" style={{ background: "#FDFBF8", padding: "25px", borderRadius: "20px", border: "1px solid rgba(218, 180, 157, 0.3)", transition: "all 0.3s ease" }}> 
              <BedDouble style={{ height: "30px", marginBottom: "15px", color: "#B79A8A", strokeWidth: 1.3 }} /> 
            ...
            {/* Item 2 */} 
            <div className="dh-service-card" style={{ background: "#FDFBF8", padding: "25px", borderRadius: "20px", border: "1px solid rgba(218, 180, 157, 0.3)", transition: "all 0.3s ease" }}> 
              <Sparkles style={{ height: "30px", marginBottom: "15px", color: "#B79A8A", strokeWidth: 1.3 }} /> 
            ...
            {/* Item 3 */} 
            <div className="dh-service-card" style={{ background: "#FDFBF8", padding: "25px", borderRadius: "20px", border: "1px solid rgba(218, 180, 157, 0.3)", transition: "all 0.3s ease" }}> 
              <Wifi style={{ height: "30px", marginBottom: "15px", color: "#B79A8A", strokeWidth: 1.3 }} /> 
            ...
            {/* Item 4 */} 
            <div className="dh-service-card" style={{ background: "#FDFBF8", padding: "25px", borderRadius: "20px", border: "1px solid rgba(218, 180, 157, 0.3)", transition: "all 0.3s ease" }}> 
              <ShieldCheck style={{ height: "30px", marginBottom: "15px", color: "#B79A8A", strokeWidth: 1.3 }} /> 
            ...
            {/* Item 5 */} 
            <div className="dh-service-card" style={{ background: "#FDFBF8", padding: "25px", borderRadius: "20px", border: "1px solid rgba(218, 180, 157, 0.3)", transition: "all 0.3s ease" }}> 
              <SprayCan style={{ height: "30px", marginBottom: "15px", color: "#B79A8A", strokeWidth: 1.3 }} /> 
            ...
            {/* Item 6 */} 
            <div className="dh-service-card" style={{ background: "#FDFBF8", padding: "25px", borderRadius: "20px", border: "1px solid rgba(218, 180, 157, 0.3)", transition: "all 0.3s ease" }}> 
              <CarFront style={{ height: "30px", marginBottom: "15px", color: "#B79A8A", strokeWidth: 1.3 }} /> 
            ...
            {/* Item 7 */} 
            <div className="dh-service-card" style={{ background: "#FDFBF8", padding: "25px", borderRadius: "20px", border: "1px solid rgba(218, 180, 157, 0.3)", transition: "all 0.3s ease" }}> 
              <Gamepad2 style={{ height: "30px", marginBottom: "15px", color: "#B79A8A", strokeWidth: 1.3 }} /> 
            ...
            {/* Item 8 */} 
            <div className="dh-service-card" style={{ background: "#FDFBF8", padding: "25px", borderRadius: "20px", border: "1px solid rgba(218, 180, 157, 0.3)", transition: "all 0.3s ease" }}> 
              <MapPin style={{ height: "30px", marginBottom: "15px", color: "#B79A8A", strokeWidth: 1.3 }} /> 
