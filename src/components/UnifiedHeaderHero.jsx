...
export default function UnifiedHeaderHero({ isHomePage = false, title = "" }) {
  ...
  return (
    <div className={`relative w-full overflow-hidden flex flex-col ${isHomePage ? 'min-h-[95vh]' : 'min-h-[40vh]'}`}>
...
>
  Our Services
      ...
      {/* Seamless Subtle Blue Fade & Soft Blur at Bottom Edge */}
      <div 
      ...
      >
        <div
          style={{
            position: 'absolute',
            inset: 0,
            background: 'linear-gradient(to bottom, rgba(140, 191, 232, 0) 0%, rgba(140, 191, 232, 0.35) 50%, rgba(140, 191, 232, 0.7) 100%)',
            backdropFilter: 'blur(3px)',
            WebkitBackdropFilter: 'blur(3px)',
          }}
        />
